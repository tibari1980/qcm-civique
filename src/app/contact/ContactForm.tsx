                        ...
                        <Card className="shadow-sm">
                            <CardHeader>
                                <CardTitle className="flex items-center gap-2">
                                    <Send className="h-5 w-5 text-[var(--color-primary)]" aria-hidden="true" />
                    ...
                    <div className="space-y-6">
                                ...
                                <Card key={info.title} className="shadow-sm hover:shadow-md transition-shadow">
                                    <CardContent className="p-5">
                                        <div className="flex items-start gap-4">
                                            <div className={`p-2.5 rounded-lg ${info.bg}`} aria-hidden="true">
                        ...
                        <Card className="shadow-sm bg-gradient-to-br from-blue-600 to-blue-800 text-white">
                            <CardContent className="p-5 text-center">
                                <CheckCircle className="h-10 w-10 mx-auto mb-3 text-blue-200" aria-hidden="true" />
