                ...
                <div className="container mx-auto px-4 max-w-5xl">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-white text-center">
                        {stats.map((stat) => {
                            ...
                            return (
                                <div key={stat.label} className="flex flex-col items-center gap-2" aria-label={`${stat.label} : ${stat.value}`}>
                                    <Icon className="h-6 w-6 opacity-80" aria-hidden="true" />
                                    <span className="text-3xl font-extrabold" aria-hidden="true">{stat.value}</span>
                                    <span className="text-blue-200 text-sm" aria-hidden="true">{stat.label}</span>
                                </div>
                            );
                        })}
                    </div>
