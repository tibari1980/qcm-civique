...
export function AnnouncementBanner() {
    ...
    return (
        <div
            className="bg-[var(--color-primary)] text-white px-4 py-2 relative overflow-hidden animate-in fade-in slide-in-from-top duration-500"
            role="status"
        ...
        >
            ...
            <div className="container mx-auto flex items-center justify-center gap-3 text-sm font-medium">
                ...
                <button
                    ...
                    className="ml-auto p-1 hover:bg-white/20 rounded transition-colors focus:ring-2 focus:ring-white outline-none"
                    aria-label="Fermer l'accueil de l'annonce"
                >
