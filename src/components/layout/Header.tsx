        ...
        <header className="sticky top-0 z-50 w-full border-b border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md glass-card !rounded-none !shadow-none !border-x-0 !border-t-0">
            <div className="container mx-auto px-4 md:px-6">
                <div className="flex h-16 items-center justify-between">
                    ...
                    {/* Restricted Desktop View */}
                    {isRestricted && (
                        <div className="hidden md:flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 animate-in fade-in zoom-in duration-500">
                             <span className="w-2 h-2 rounded-full bg-blue-600 animate-pulse" />
                             <span className="text-[10px] font-black uppercase tracking-widest text-blue-700 dark:text-blue-300">Configuration du parcours obligatoire</span>
                        </div>
                    )}
                        ...
                        <nav aria-label="Navigation mobile" className="flex flex-col gap-4">
                            {!isRestricted ? (
                                ...
                                <div className="p-4 bg-blue-50 dark:bg-blue-900/10 rounded-2xl border border-blue-100 dark:border-blue-800/20">
                                    <p className="text-xs font-bold text-blue-800 dark:text-blue-300 mb-1">Action Requise</p>
                                    <p className="text-[11px] text-blue-600 dark:text-blue-400 leading-relaxed font-medium">Veuillez choisir votre parcours pour débloquer toutes les fonctionnalités de votre espace personnel.</p>
                                </div>
                            )}
